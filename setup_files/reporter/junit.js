...
module.exports = new (function () {
  ...
  function writeReport(moduleKey, template, opts, callback) {
  ...
  this.write = function (results, options, callback) {
    ...
    getTemplate(function createReport(template) {
      var moduleKey = keys.shift();

      writeReport(moduleKey, template, options, function (err) {
